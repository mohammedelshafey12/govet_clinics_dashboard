...
class Store {
  ...
  addClinic(ClinicModel clinic) {
    fireStore.collection(Constants.clinicCollection).doc(clinic.clinicId).set({
      ...
      Constants.clinicServices: clinic.clinicServices,
      Constants.clinicAbout: clinic.clinicAbout,
      Constants.clinicPhone: clinic.clinicPhone,
      Constants.clinicOldPrice: clinic.clinicOldPrice,
      Constants.clinicNewPrice: clinic.clinicNewPrice,
      Constants.clinicWorksHoursFrom: clinic.clinicWorksHoursFrom,
      Constants.clinicWorksHoursTo: clinic.clinicWorksHoursTo,
      Constants.clinicLocation: clinic.clinicLocation,
      Constants.clinicRate: clinic.clinicRate,
